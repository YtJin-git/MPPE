...
parser.add_argument("--wandb_name", help="wandb name", type=str, default="wandb-name")
parser.add_argument("--mu_index", help="choose mu index", type=str, default="mu-index")

parser.add_argument("--graph_init", help="graph init", type=str)
parser.add_argument("--graph_gr_emb", type=str, default='d4096,d')
parser.add_argument("--graph_gcn_type", type=str, default='gcn')
parser.add_argument("--graph_emb_dim", type=str, default='768')